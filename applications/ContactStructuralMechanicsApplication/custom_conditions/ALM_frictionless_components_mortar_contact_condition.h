...
class AugmentedLagrangianMethodFrictionlessComponentsMortarContactCondition: public AugmentedLagrangianMethodMortarContactCondition<TDim, TNumNodes, false, TNormalVariation> 
{
public:
    ///@name Type Definitions
    ///@{
