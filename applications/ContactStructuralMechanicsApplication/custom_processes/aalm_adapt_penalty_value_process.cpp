...
//         // DEBUG
//         KRATOS_INFO("Current gap") << "current_gap: " << current_gap << "\tprevious_gap: " << previous_gap << "\tmax_gap: " << max_gap << std::endl;
//         KRATOS_INFO("Sign change gaps") << "(current_gap * previous_gap): " << (current_gap * previous_gap) << std::endl;
//         KRATOS_INFO("Compare previous gap") << "std::abs(previous_gap) > max_gap: " << std::abs(previous_gap) > max_gap << std::endl;
//         KRATOS_INFO("Compare current gap") << "std::abs(current_gap) > max_gap: " << std::abs(current_gap) > max_gap << std::endl;
